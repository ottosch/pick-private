...
// Encode encodes human-readable part and data into bech32/bech32m.
// If HRP is uppercase, returns uppercase.
...
// Decode decodes bech32/bech32m string into human-readable part, data and spec (int).
